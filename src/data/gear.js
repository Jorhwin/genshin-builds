  ...
  },
  {
    ...
    weapons: [
      ...
      },
      {
        ...
        rarity: "5-star",
        bestFor: "Eula",
        why: "ATK plus a team ATK buff and Physical DMG bonus — Eula's signature and clearly her best weapon.",
      },
      {
        name: "Snow-Tombed Starsilver",
        rarity: "4-star (craftable)",
        bestFor: "Eula, Chongyun",
        why: "Free Physical DMG claymore with an on-hit proc — the best craftable option for Physical carries.",
      },
    ],
  },
  {
    ...
    weapons: [
      ...
      },
      {
        ...
        rarity: "5-star",
        bestFor: "Emilie",
        why: "ATK plus EM and skill damage — purpose-built for Emilie's off-field Dendro kit.",
      },
      {
        name: "Deathmatch",
        rarity: "4-star (Battle Pass)",
        bestFor: "Emilie, Yun Jin",
        why: "CRIT Rate plus ATK when near enemies — a strong generic polearm for on-fielders.",
      },
      {
        name: "Dragonspine Spear",
        rarity: "4-star (event)",
        bestFor: "Emilie, Rosaria",
        why: "Free Physical DMG polearm with a bonus against affected enemies — a decent F2P option.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    weapons: [
      ...
      },
      {
        ...
        rarity: "5-star",
        bestFor: "Sigewinne",
        why: "HP scaling plus healing bonus — purpose-built for Sigewinne's kit.",
      },
      {
        name: "Favonius Warbow",
        rarity: "4-star",
        bestFor: "Sigewinne, Diona, support bows",
        why: "Team energy generation for bow supports that need to battery the team.",
      },
      {
        name: "Recurve Bow",
        rarity: "3-star",
        bestFor: "Sigewinne (F2P)",
        why: "HP% stat stick that is the best free option on HP-scaling bow healers.",
      },
    ],
  },
];
...
export const artifactSets = [
  ...
  {
    name: "Pale Flame",
    bestFor: "Eula, Hu Tao, Yoimiya, Diluc, Freminet",
    why: "Physical DMG plus a stacking ATK buff after using the skill — the best set for Physical carries.",
    caveat: "Only useful on Physical-scaling characters; wasted on everyone else.",
  },
  {
    name: "Song of Days Past",
    bestFor: "Sigewinne, Kokomi, Charlotte, healing buffers",
    why: "Converts outgoing healing into a team damage bonus — turns pure healers into support DPS.",
    caveat: "The damage bonus scales with healing, so it falls off on low-damage teams.",
  },
  {
    name: "Unfinished Reverie",
    bestFor: "Emilie, burning-team Dendro DPS",
    why: "Dendro DMG plus a stacking damage bonus after applying burning — built for Emilie's kit.",
    caveat: "Requires a burning team to trigger the stacks, so it is effectively Emilie-specific.",
  },
];
